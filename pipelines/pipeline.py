...
import kfp
from kfp.dsl import component, Model, Output, Dataset, Metrics, Input, pipeline
...
@pipeline(name="cat-dog-training-pipeline", pipeline_root=f"gs://{BUCKET_NAME}/pipelines")
